 ...
 * Use the {@link MoviesWatchListFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MoviesWatchListFragment extends Fragment implements MoviesAdapter.MovieOptionsListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.fragment_movies_watch_list, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        moviesAdapter = new MoviesAdapter(getContext(), new ArrayList<>(), this, false,
                true, false);
    ...
    private void loadWatchList() {
        ...
        db.collection("users").document(uid).collection("watchlist")
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(getContext(), "Failed to load your watchlist", Toast.LENGTH_SHORT).show();
                });
    }
    ...
    public void onOptionSelected(Movie movie, MoviesAdapter.OptionType option) {
        if (option == MoviesAdapter.OptionType.REMOVE_FROM_WATCHLIST) {
    ...
    public static MoviesWatchListFragment newInstance() {
        return new MoviesWatchListFragment();
    }
}